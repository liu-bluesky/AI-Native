...
def get_settings() -> Settings:
    return Settings(
        ...
        external_agent_claude_bin=str(os.environ.get("EXTERNAL_AGENT_CLAUDE_BIN", "")).strip(),
        external_agent_gemini_bin=str(os.environ.get("EXTERNAL_AGENT_GEMINI_BIN", "")).strip(),
        external_agent_runner_url=str(os.environ.get("EXTERNAL_AGENT_RUNNER_URL", "")).strip(),
    )
