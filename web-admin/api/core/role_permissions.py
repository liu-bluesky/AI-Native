...
MENU_PERMISSION_ITEMS = [
    ...
    {"key": "menu.departments", "label": "部门管理", "path": "/departments"},
    ...
    {"key": "menu.feedback", "label": "用户反馈", "path": "/feedback"},
    {"key": "menu.feedback.admin", "label": "反馈处理中心", "path": "/admin/feedback"},
    {"key": "menu.statistics", "label": "统计", "path": "/statistics"},
...
BUTTON_PERMISSION_ITEMS = [
    ...
    {"key": "button.departments.create", "label": "部门管理-新增部门"},
    {"key": "button.departments.update", "label": "部门管理-编辑部门"},
    {"key": "button.departments.delete", "label": "部门管理-删除部门"},
    {"key": "button.departments.assign_users", "label": "部门管理-分配用户"},
    {"key": "button.roles.create", "label": "角色管理-新增角色"},
    {"key": "button.roles.update", "label": "角色管理-编辑角色"},
    {"key": "button.roles.delete", "label": "角色管理-删除角色"},
    {"key": "button.changelog.create", "label": "更新日志-新增"},
    {"key": "button.changelog.update", "label": "更新日志-编辑"},
    {"key": "button.changelog.delete", "label": "更新日志-删除"},
