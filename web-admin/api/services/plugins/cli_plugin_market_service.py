...
from services.plugins.cli_plugin_profile_service import build_cli_plugin_profile_runtime_env
...
def _install_script_path() -> Path:
    return Path(__file__).resolve().parents[2] / "scripts" / "install_cli_plugin.sh"
