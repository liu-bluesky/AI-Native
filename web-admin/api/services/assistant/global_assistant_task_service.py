    ...
    *,
    ...
    for action in task.get("actions") or []:
        ...
        if action_type == "feishu_message":
            try:
                from services.feishu.feishu_scheduled_reminder_service import send_feishu_scheduled_message
...
def _enqueue_system_speech_action(task: dict[str, Any], action: dict[str, Any]) -> dict[str, Any]:
    ...
    if require_enabled:
        from services.providers.system_speech_service import is_system_speech_allowed
