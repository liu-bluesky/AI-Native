    ...
    children: [
      ...
      { path: 'ai/supervision', component: () => import('../views/desktop/AgentSupervision.vue') },
      {
        ...
        children: [
          ...
          { path: 'agent-feedback/:id', component: () => import('../views/evolution/FeedbackTicketList.vue') },
          { path: 'agent-feedback/:id/batch-analyze', component: () => import('../views/evolution/FeedbackBatchAnalyze.vue') },
          { path: 'agent-feedback/:id/:feedbackId', component: () => import('../views/evolution/FeedbackDetail.vue') },
      ...
      { path: 'llm/providers', component: () => import('../views/llm/ModelProviderManager.vue') },
      { path: 'market', component: () => import('../views/public/MarketPage.vue') },
      { path: 'feedback', component: () => import('../views/feedback/UserFeedbackCenter.vue') },
      { path: 'admin/feedback', component: () => import('../views/feedback/AdminUserFeedbackCenter.vue') },
      { path: 'agent-feedback/:id', component: () => import('../views/evolution/FeedbackTicketList.vue') },
      { path: 'agent-feedback/:id/batch-analyze', component: () => import('../views/evolution/FeedbackBatchAnalyze.vue') },
      { path: 'agent-feedback/:id/:feedbackId', component: () => import('../views/evolution/FeedbackDetail.vue') },
    ],
