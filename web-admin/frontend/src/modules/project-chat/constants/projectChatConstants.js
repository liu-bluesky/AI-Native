...
export const SYSTEM_MCP_COMMAND = "/mcp";
export const SYSTEM_MCP_COMMAND_ALIASES = ["/系统mcp", "/project-mcp"];
export const SKILL_COMMAND = "/skill";
export const SKILL_COMMAND_ALIASES = ["/技能", "/skills"];
export const AGENT_COMMAND = "/agent";
export const AGENT_COMMAND_ALIASES = ["/员工", "/智能体", "/employee"];
export const RULE_COMMAND = "/rule";
export const RULE_COMMAND_ALIASES = ["/规则", "/rules"];
export const FILE_COMMAND = "/file";
export const FILE_COMMAND_ALIASES = ["/文件", "/附件", "/attach"];
export const HOST_RUN_COMMAND = "/run";
export const HOST_RUN_COMMAND_ALIASES = ["/host-run", "/shell"];
export const PACKAGE_DEPLOY_COMMAND = "/打包部署";
export const PACKAGE_DEPLOY_COMMAND_ALIASES = ["/部署", "/package-deploy", "/deploy"];
...
export const PROJECT_DEPLOY_DRAFT_STORAGE_PREFIX = "project-deploy-draft:";
export const PROJECT_DEPLOY_DRAFT_QUERY_KEY = "project_deploy_draft_key";
