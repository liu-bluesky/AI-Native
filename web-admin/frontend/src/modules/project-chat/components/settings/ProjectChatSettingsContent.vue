      ...
      >
        ...
        >
                      ...
                      >
                        <div class="settings-module-section__head">
                          <div>
                            <strong>插件与工具</strong>
                            <span
                              >按项目启用扩展能力；未启用的插件不会进入 AI 工具列表。MCP registry 和 Web 搜索
                              provider。</span
                            >
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div class="settings-module-row__main">
                            ...
                            <span>
                              ...
                              {{ plugin.source === "project" ? "项目" : "用户" }}级
                              <template v-if="plugin.version"> · v{{ plugin.version }}</template>
                              <template v-if="plugin.error"> · {{ plugin.error }}</template>
                            </span>
                          </div>
                          <el-switch
                        ...
                        <div v-if="!localPluginCatalog.length" class="settings-module-hint">
                          将插件放入 `.ai-employee/plugins/&lt;plugin-id&gt;/plugin.json`，重新打开设置即可发现。
                        </div>
                        <article class="settings-module-row">
                          <div class="settings-module-row__icon">
                            <el-icon><CollectionTag /></el-icon>
          ...
          <div v-else class="settings-center-stage__body">
            <component :is="settingsChildComponent" v-if="settingsChildComponent" />
          </div>
        </section>
      </div>
    </div>
...
<style
  scoped
  src="../../styles/project-chat-style-01.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-02.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-03.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-04.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-05.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-06.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-07.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-08.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-09.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-10.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-11.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-12.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-13.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-14.css"
></style>

<style
  scoped
  src="../../styles/project-chat-style-15.css"
></style>
...
.settings-center-stage__body--chat .settings-module-list::-webkit-scrollbar-thumb {
