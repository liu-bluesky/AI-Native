...
use tools::file::{
    apply_patch, delete_file, delete_local_resource, list_files, list_local_resources, read_file,
    read_local_resource, search_text, write_file,
};
...
pub(crate) fn execute_tool_with_command_output_sink_and_cancel(
    ...
    let result = match name.as_str() {
        ...
        "delete_local_resource" => delete_local_resource(
            &tool_call_id,
            &request.arguments,
