...
await assertIncludes("src/utils/native-desktop-bridge.js", [
  ...
  "readGlobalProjectCatalogFile",
  "writeGlobalProjectCatalogFile",
...
await assertIncludes("src-tauri/src/liuagent_core/project_catalog.rs", [
  "global_project_catalog_path",
  '.join("projects")',
  '.join("catalog.json")',
]);
