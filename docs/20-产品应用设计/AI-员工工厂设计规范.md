...
- 图中的“前端专家 / 后端专家 / 测试工程师 / 运维专家”只是示意案例，用于说明员工可以按技能、规则、记忆和人设组合，不构成固定行业限制。
- 实际产品应支持任意领域、任意职责组合，也应支持由 AI 基于上下文自主判断是单人闭环还是多人协作。
...
5. **多员工管理**: 创建专属团队，由 AI 结合上下文自主决定单人闭环或多人协作

### 8.3 应用场景

以下场景和员工名称仅为示例，不限制行业，也不意味着系统必须按固定角色模板协作。
